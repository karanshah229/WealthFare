...
<div class="uk-section uk-text-medium">
    <div class="uk-container">
        <h1>Blog</h1>
        <div>Wealthfare is a storehouse of blogs covering topics on personal finance, corporate finance, public finance, marketing, economics, global markets many more. We strive to make finance understandable and want to translate our love of the field to make it more enjoyable.</div>
    </div>
</div>
...
<?php 
    ...
    foreach($categories as $category) {
        ...
        while ( $popularpost->have_posts() ){
            ...
            $articleTemp .= '<p class="uk-article-meta">Written by '.get_the_author_posts_link().' on <span uk-icon="calendar"></span>'.get_the_date('d-m-Y');
        ...
        $rightDiv = '<div class="uk-width-1-3@m"><div class="right-div" style="font-size: 1.5rem; color: #1e90ff;">Most Read Posts</div>';
